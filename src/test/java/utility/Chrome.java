...
public class Chrome {
    ...
    public static void getURL() {
        Hook.getSeleniumDriver().get("https://qa.andes.engine.kata-software.com/");
        Hook.getSeleniumDriver().manage().window().maximize();
    }
    public static void insertValue(By element, String value) {
        Hook.getSeleniumDriver().findElement(element).clear();
        Hook.getSeleniumDriver().findElement(element).sendKeys(value);
    }
    ...
    public static void giveClick(By element) {
        Hook.getSeleniumDriver().findElement(element).click();
    }
...
//        wait.until(ExpectedConditions.visibilityOf((WebElement) element));
        ...
        boolean displayed = Hook.getSeleniumDriver().findElement(element).isDisplayed();
        if (displayed){
    ...
    public static void giveEnter(By element) {
        Hook.getSeleniumDriver().findElement(element).sendKeys(Keys.ENTER);
    }

    public static String getText(By element) {
        return Hook.getSeleniumDriver().findElement(element).getText();
    }
...
//    }
    ...
    public static void retroceso(){
        Hook.getSeleniumDriver().findElement(By.id("Value")).sendKeys(Keys.RETURN);
        Hook.getSeleniumDriver().findElement(By.id("Value")).sendKeys(Keys.RETURN);
    }
    public static Boolean isVisible(By element)
    {
        return Hook.getSeleniumDriver().findElement(element).isDisplayed();
    }

    public static void uiScrollableByText(String _scrollContainer, String _childElement, String _value) {
        MobileElement element = (MobileElement) Hook.getSeleniumDriver().findElement(MobileBy.AndroidUIAutomator(
    ...
    public static void uiwebViewByText(String _viewContainer,String _childElement,String _value) {
        MobileElement element = (MobileElement) Hook.getSeleniumDriver().findElement(MobileBy.AndroidUIAutomator(                "new UiSelector(new UiSelector().resourceId(\"" + _viewContainer + "\")).getChildByText("
                + "new UiSelector().className(\"" + _childElement + "\"), \"" + _value + "\")"));
