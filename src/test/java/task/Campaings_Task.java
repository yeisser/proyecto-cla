...
public class Campaings_Task {
    ...
    public static By menu_VariablesSocioeconomicas = Element.Mobile_Element(Constantes.XPATH, "//*[@text='Variables socioeconómicas']");
    public static By menu_AnalisisCualitativoPersonal = Element.Mobile_Element(Constantes.XPATH, "//*[@text='Análisis Cualitativo - Personal']");
    public static By menu_EstadosDeResultadosPersonas = Element.Mobile_Element(Constantes.XPATH, "//*[@text='Estados de resultados - Personal']");
    public static By btn_botonFiadores = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[3]/android.view.View/android.widget.Button");
    public static By btn_CrearFiadores = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[2]/android.widget.Button");
    public static By campo_TipoGuardadoDelFormularioFiadores = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[2]/android.widget.TextView[2]");
    public static By campo_ReferenciaDireccion = Element.Mobile_Element(Constantes.XPATH, "//android.widget.EditText[4]/android.view.View");
    public static By campo_TipoDeVivienda = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][1]/android.widget.EditText/android.view.View");
    public static By campo_TipoConstruccion = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][2]/android.widget.EditText/android.view.View");
    public static By campo_TipoDeSector = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][3]/android.widget.EditText/android.view.View");
    public static By campo_AñosDeResidencia = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[1]/android.view.View[2]/android.widget.EditText/android.view.View");
    public static By campo_Ocupacion = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][2]/android.widget.EditText/android.view.View");
    public static By campo_Cargo = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][3]/android.widget.EditText/android.view.View");
    public static By campo_NumeroDePersonasDependientes = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[3]/android.view.View/android.view.View[1]/android.widget.EditText/android.view.View");
    public static By campo_NumeroDeHijos = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[3]/android.view.View/android.view.View[2]/android.widget.EditText/android.view.View");
    public static By campo_TipoDeIngreso = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][2]/android.widget.EditText/android.view.View");
    public static By radio_NoCambioDeActividadPrincipal = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[4]/android.view.View[2]/android.widget.TextView");
    public static By radio_NoEnSeguroOptativos = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[2]/android.view.View[2]/android.view.View[2]/android.widget.TextView");
    public static By btn_Sobreendeudamiento = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[3]/android.view.View/android.widget.Button");
    public static By btn_MotorDeDecisionDeClienteNoBancarizado = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[4]/android.view.View/android.widget.Button");
    public static By campo_TiempoEnDomicilio = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][1]/android.widget.EditText/android.view.View");
    public static By campo_NroClientesSemanales = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[1]/android.view.View[2]/android.widget.EditText/android.view.View");
    public static By campo_NroTrabajadores = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][2]/android.widget.EditText/android.view.View");
    public static By campo_TiempoExperienciaEnElNegocio = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][3]/android.widget.EditText/android.view.View");
    public static By campo_HijosEdadEscolar = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][4]/android.widget.EditText/android.view.View");
    public static By campo_PosicionEnElHogar = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][3]/android.widget.EditText/android.view.View");
    public static By radio_SiPagaPorInternet = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[4]/android.view.View[1]/android.widget.TextView");
    public static By campo_DistanciaDelNegocio = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][4]/android.widget.EditText/android.view.View");
    public static By radio_SiPagaPorLuz = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[6]/android.view.View[1]/android.widget.TextView");
    public static By radio_SiPagaPorAgua = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[5]/android.view.View[1]/android.widget.TextView");
    public static By campo_ReglasCaja = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[2]/android.view.View[1]/android.view.View/android.widget.Button");
    public static By campo_VinculoReferencia = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][2]/android.widget.EditText/android.view.View");
    public static By campo_NombreReferencia = Element.Mobile_Element(Constantes.XPATH, "//androidx.compose.ui.platform.m1/android.view.View/android.view.View/android.view.View[2]/android.widget.EditText[1]/android.view.View");
    public static By campo_DireccionReferencia = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[2]/android.widget.EditText[2]/android.view.View");
    public static By campo_TelefonoReferencia = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[3]/android.view.View/android.view.View/android.widget.EditText/android.view.View");
    public static By campo_ComentariosReferencia = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[3]/android.view.View/android.view.View/android.widget.EditText/android.view.View");
    public static By campo_guardoReferencia = Element.Mobile_Element(Constantes.XPATH, "//*[@text='GUARDAR']");
    public static By btn_RetrocederReferencia = Element.Mobile_Element(Constantes.XPATH, "//android.widget.ImageView[@content-desc='Ir atrás']");
    public static By campo_IngresoPrincipal = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][1]/android.widget.EditText/android.view.View");
    public static By campo_IngresoSecundario = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][2]/android.widget.EditText/android.view.View");
    public static By campo_TiempoExperiencia = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][3]/android.widget.EditText/android.view.View");
    public static By campo_EstabilidadLaboral = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][4]/android.widget.EditText/android.view.View");
    public static By campo_NombreEmpresa = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[1]/android.view.View[2]/android.widget.EditText[1]/android.view.View");
    public static By campo_RUCEmpresa = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[1]/android.view.View[2]/android.widget.EditText[2]/android.view.View");
    public static By campo_SectorLaboral = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][1]/android.widget.EditText/android.view.View");
    public static By campo_ReferenciaUbicacion = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[2]/android.widget.EditText[2]/android.view.View");
    public static By campo_DocumentoIngresos = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[@content-desc='Menú desplegable'][2]/android.widget.EditText/android.view.View");
    public static By radio_SIEnCapacidadDeAhorro = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[2]/android.view.View[3]/android.view.View[1]");
    public static By campo_IngresoNetoTitular = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[2]/android.widget.EditText[1]/android.view.View");
    public static By campo_ComentariosDePropuestaDeCredito = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[2]/android.widget.EditText[5]/android.view.View");
    public static By btn_GarantiasTitutlarConyugue = Element.Mobile_Element(Constantes.XPATH, "//android.view.View[2]/android.view.View[1]/android.view.View/android.widget.Button");
